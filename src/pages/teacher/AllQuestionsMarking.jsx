...
function injectMarkingStyles() {
  ...
  style.textContent = `
    ...
    /* ── KNEC-style marking layout: toolbar strip, answer / quick-mark / scheme
       three-up, and a bottom coloured action bar — see this file's render,
       and the identical block in Marking.jsx which this mirrors. ── */
    .mkp-toolbar-row {
    ...
    <div className="mkp-root">
      ...
      {!current ? (
        ...
        <div style={s.qCard} className="mkp-card" key={current.id}>
          ...
          {/* ── Bottom action bar — Back / Skip / Save and Move Next,
